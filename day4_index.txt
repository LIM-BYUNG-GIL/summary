...
public class C11_Boolean {
	public static void main(String[] args) {
		...
		// 아래 2개의 논리식은 첫번째 값이 false 이므로 두번째 값이 무엇이든 상관없이 false
		...
		// 위 2개의 논리식은 첫번째 값이 true 이므로 두번째 값이 무엇이든 상관없이 true
		...
		System.out.println("모범학생 ? " + (korean >= 90 || math >= 90));
...
/*
 * 데이터의 기본 형식 : boolean은 true 또는 false 값을 갖는 형식. (Boolean 래퍼 클래스도 있다)
 * 
